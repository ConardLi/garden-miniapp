...
// 预设表情列表
const EXPRESSIONS = [
  { id: 'smile', name: '微笑', emoji: '😊', prompt: '让他/她露出温暖自然的微笑' },
  { id: 'happy', name: '开心', emoji: '😄', prompt: '让他/她开心地大笑' },
  { id: 'angry', name: '生气', emoji: '😠', prompt: '让他/她生气的表情' },
  { id: 'sad', name: '伤心', emoji: '😢', prompt: '让他/她露出伤心的表情' },
  { id: 'surprised', name: '惊讶', emoji: '😲', prompt: '让他/她露出惊讶的表情' },
  { id: 'cute', name: '可爱', emoji: '🥰', prompt: '让他/她露出可爱的表情' },
  { id: 'proud', name: '得意', emoji: '😏', prompt: '让他/她露出得意的表情' },
  { id: 'shy', name: '害羞', emoji: '😳', prompt: '让他/她露出害羞的表情' },
  { id: 'serious', name: '严肃', emoji: '😐', prompt: '让他/她露出严肃的表情' },
  { id: 'confused', name: '困惑', emoji: '🤔', prompt: '让他/她露出困惑的表情' },
  { id: 'sleepy', name: '困倦', emoji: '😴', prompt: '让他/她露出困倦的表情' },
  { id: 'excited', name: '兴奋', emoji: '🤩', prompt: '让他/她露出兴奋的表情' }
];
...
Page({
  ...
  // 调整编辑强度
  adjustScale(e) {
    const scale = e.detail.value / 100;  // 将百分比转换回0-1的值
